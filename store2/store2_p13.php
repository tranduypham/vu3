    ...
    <main>
      <div class="product-page">
          <div class ="product-page-img">
            <img class="image-feature" src="../img/products/product37.jpg" alt="P1-Ultra Men's Running Jacket">
          </div>
          <div class ="product-detail">
            <h1 class='product-title'>P1-Ultra Men's Running Jacket</h1>
            <h2 class='product-price'>Price: $90</h2>
            <a href="#" class="add-button">Add To Cart</a>
            <a href="../store/mycart.php" class="buy-button">Buy Now</a>
            <div>
                <p>Description</p>
            </div>
            <p>The Ultra Running Jacket is made to race against the elements. This ventilated zip-up maintains your body temp with windCELL for windchill, dryCELL for a damp day, and 360 ref...</p>
          </div>
      </div>
