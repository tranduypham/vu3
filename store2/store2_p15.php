    ...
    <main>
      <div class="product-page">
          <div class ="product-page-img">
            <img class="image-feature" src="../img/products/product39.jpg" alt="P3-RS-X Arcade Men's Sneakers">
          </div>
          <div class ="product-detail">
            <h1 class='product-title'>P3-RS-X Arcade Men's Sneakers</h1>
            ...
            <p>RS-X reimagines PUMA's retro running silhouette from the '80s with fresh color combos, amplified detailing and a bold and unapologetic design. Inspired by old school video games and an arcade aesthetic, this edition of RS-X is ready for some retro play.</p>
          </div>
      </div>
