    ...
    <main>
      <div class="product-page">
          <div class ="product-page-img">
            <img class="image-feature" src="../img/products/product2.jpg" alt="N1-Nike Sportwear">
          </div>
          <div class ="product-detail">
            <h1 class='product-title'>N1-Nike Sportwear</h1>
            ...
            <p>Made from a fabric that blends at least 75% recycled and organic fibres, the Nike Sportswear T-Shirt is a heavyweight tee with a relaxed fit.An applique made from recycled fibres complements the printed graphics on the chest and back.This product is made from 100% sustainable materials, using a blend of recycled polyester, recycled cotton and organic cotton fibres.The blend is at least 10% recycled fibres or at least 10% organic cotton fibres.</p>
          </div>
      </div>
