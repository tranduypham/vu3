    ...
    <main>
      <div class="product-page">
          <div class ="product-page-img">
            <img class="image-feature" src="../img/products/product30.jpg" alt="A2-Mike Tee">
          </div>
          <div class ="product-detail">
            <h1 class='product-title'>A2-Mike Tee</h1>
            ...
            <p> Who says cartoons aren't for grown-ups? Definitely not you. Disney's Mike from "Monster's Inc." steps in as the lead character in this t-shirt's graphic inspired by the iconic adidas Stan Smith tongue label. Throw it on for instant street cred. Organic cotton jersey makes you feel good inside and out.<br>This product is made with organic cotton and is part of our ambition to end plastic waste. It's also coloured using a more sustainable technology to cause less harm.</p>
          </div>
      </div>
