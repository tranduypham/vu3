    ...
    <main>
      <div class="product-page">
          <div class ="product-page-img">
            <img class="image-feature" src="../img/products/product33.jpg" alt="U1-MEN Pile Lined Sweat Pants">
          </div>
          <div class ="product-detail">
            <h1 class='product-title'>U1-MEN Pile Lined Sweat Pants</h1>
            ...
            <p> - The outer sweat fabric and the boa fleece lining provide a sleek silhouette.<br>- The overall slack is adjusted to create a flattering cut.<br>- Fleece is used on both sides of the pocket lining, making your hands warm straight away.</p>
          </div>
      </div>
