    ...
    <main>
      <div class="product-page">
          <div class ="product-page-img">
            <img class="image-feature" src="../img/products/product43.jpg" alt="F3-UNISEX DALLAS CREW">
          </div>
          <div class ="product-detail">
            <h1 class='product-title'>F3-UNISEX DALLAS CREW</h1>
            ...
            <p>-Unisex velour sweatshirt<br>-Regular fit for men<br>-Oversize fit for women (please size down for regular fit)<br>-Ribbed sleeve cuffs<br>-Ribbed hem<br>-Crew neck with ribbed detailing<br>-All over embossed print<br>-Outline FILA embroidered logo to chest</p>
          </div>
      </div>
