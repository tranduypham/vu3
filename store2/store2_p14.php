    ...
    <main>
      <div class="product-page">
          <div class ="product-page-img">
            <img class="image-feature" src="../img/products/product38.jpg" alt="P2-Downtown Men's Graphic Hoodie">
          </div>
          <div class ="product-detail">
            <h1 class='product-title'>P2-Downtown Men's Graphic Hoodie</h1>
            <h2 class='product-price'>Price: $70</h2>
            <a href="#" class="add-button">Add To Cart</a>
            <a href="../store/mycart.php" class="buy-button">Buy Now</a>
            <div>
                <p>Description</p>
            </div>
            <p>Made from 30% recycled cotton, the Downtown Hoodie is as environmentally-friendly as it is streetstyle-ready. Playful graphics and cute characters are here to remind you to take take care of our planet.</p>
          </div>
      </div>
