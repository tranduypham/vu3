  ...
  <body>
    ...
    <header class="clearfix">
      <div class="logo">
          ...
          <a href="../store2/store_home2.php"><img src="../img/store/store2.jpg" alt="logo-store2">
      </div>
      <nav class="">
          <ul>
              <li><a href="../store2/store_home2.php">Store Home</a></li>
              <li><a href="../index.php">Mall Home</a></li>
              <li><a href="../mall/about.php">About us</a></li>
              <li>
                    <a href="#">Products</a>
                    <ul>
                        <li><a href="../store2/browse_time2.php">Browse Products by Time Created</a></li>
                        <li><a href="../store2/browse_Pcategory2.php">Browse Products by Category</a></li>
                    </ul>
                </li>
