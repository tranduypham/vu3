    ...
    <main>
      <div class="product-page">
          <div class ="product-page-img">
            <img class="image-feature" src="../img/products/product12.jpg" alt="Nintendo Switch Lite">
          </div>
          <div class ="product-detail">
            <h1 class='product-title'>Nintendo Switch Lite</h1>
            <h2 class='product-price'>Price: $250</h2>
            <a href="#" class="add-button">Add To Cart</a>
            <a href="../store/mycart.php" class="buy-button">Buy Now</a>
            <div>
                <p>Description</p>
            </div>
            <p>-Handheld Nintendo Switch gaming at a great price<br>-For every member of your family, there’s a member of ours<br>-Optimized for personal, handheld play, the Nintendo Switch Lite is a small and light Nintendo Switch system<br>-Features a sleek, unibody design with fully integrated controls and a built-in +Control Pad<br>-Compatible with all physical and digital Nintendo Switch games that support Handheld mode</p>
          </div>
      </div>
