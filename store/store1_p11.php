    ...
    <main>
      <div class="product-page">
          <div class ="product-page-img">
            <img class="image-feature" src="../img/products/product16.jpg" alt="Xbox One 1TB">
          </div>
          <div class ="product-detail">
            <h1 class='product-title'>Xbox One 1TB</h1>
            ...
            <p>-This product includes: 1TB hard drive Xbox One, newly updated Xbox One black wireless controller with a 3.5mm headset jack so you can plug in any compatible headset, 14-day trial of Xbox Live Gold, AC Power Cable, and an HDMI Cable<br>-Get new game content first on Xbox<br>-Quickly switch between your games, live TV, and apps like Amazon Video, Netflix, YouTube, and HBO GO<br>-Play select Xbox 360 games on your Xbox One with backwards compatibility.Physical copy for game inside, requires Xbox Live and up to 45 GB</p>
          </div>
      </div>
