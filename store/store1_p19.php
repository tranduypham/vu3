    ...
    <main>
      <div class="product-page">
          <div class ="product-page-img">
            <img class="image-feature" src="../img/products/product24.jpg" alt="Zelda Breath of the Wild Switch">
          </div>
          <div class ="product-detail">
            <h1 class='product-title'>Zelda Breath of the Wild Switch</h1>
            ...
            <p>-Discover Hyrule as never before: by making your own path, choices, and consequences<br>-Ingenuity is the key to survival: find multiple solutions to tons of dynamic puzzles<br>-Surprises hide around every corner: scavenge weapons, armor, plants, animals, and more<br>-Live off the land: find weapons and armor, cook food, and brew elixirs<br>-Utilize special technology: the in-game Sheikah Slate controls, objects and enemies in fun ways</p>
          </div>
      </div>
