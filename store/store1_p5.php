    ...
    <main>
      <div class="product-page">
          <div class ="product-page-img">
            <img class="image-feature" src="../img/products/product10.jpg" alt="Nintendo Switch V2">
          </div>
          <div class ="product-detail">
            <h1 class='product-title'>Nintendo Switch V2</h1>
            ...
            <p>-3 Play Styles: TV Mode, Tabletop Mode, Handheld Mode<br>-6.2-inch, multi-touch capacitive touch screen<br>-4.5-9+ Hours of Battery Life will vary depending on software usage conditions<br>-Connects over Wi-Fi for multiplayer gaming; Up to 8 consoles can be connected for local wireless multiplayer</p>
          </div>
      </div>
